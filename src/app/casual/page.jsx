...
function Page() {
    ...
    let filtered = data?.products.filter((item) => item?.category?.toLowerCase().includes("casual"))
    ...
    return (
        <div>
            ...
            <div className='md:mx-20 py-5 flex flex-col items-center justify-center'>
                <p className='text-2xl md:text-3xl font-bold text-center'>CASUAL OUTFITS</p>
